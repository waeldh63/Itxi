...
useEffect(() => {
  ...
  return (
    <View
      ...
      <View style={{ height: 150, width: '80%',borderColor:"#000",borderWidth:2,borderRadius:15,marginBottom:20 }}> 
              <ScrollView contentContainerStyle={{ padding: 5 }}>
                {VoiceOptions.map((item) => (
                  <TouchableOpacity key={item.voiceId} onPress={()=>toggleSelection(item.voiceId)}>
